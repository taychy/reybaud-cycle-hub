...
import { ShoppingCart, Package, Tag, Sparkles, AlertTriangle } from "lucide-react";
import StoreProducts from "./StoreProducts";
import StoreStock from "./StoreStock";
import StoreCategories from "./StoreCategories";
import StoreCampaigns from "./StoreCampaigns";
import StockNegativoPanel from "@/components/admin/StockNegativoPanel";

type Tab = "productos" | "stock" | "inconsistencias" | "categorias" | "promociones";
...
const StoreProductosStock = () => {
  ...
  const tab: Tab =
    raw === "stock" ? "stock"
    : raw === "inconsistencias" ? "inconsistencias"
  ...
  return (
    <Tabs value={tab} onValueChange={onChange} className="w-full space-y-4">
      <TabsList className="bg-secondary">
        ...
        <TabsTrigger value="inconsistencias" className="gap-1.5">
          <AlertTriangle className="w-4 h-4" /> Inconsistencias
        </TabsTrigger>
      ...
      <TabsContent value="inconsistencias" className="mt-0"><StockNegativoPanel /></TabsContent>
