            ...
            return (
              <>
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-2">
                  <Card><CardContent className="p-3"><div className="text-[10px] uppercase text-muted-foreground">Esperado total</div><div className="font-heading text-xl">{ars(Number(summary.esperado_cobrar))}</div><div className="text-[10px] text-muted-foreground mt-0.5">{summary.moneda_items !== "ARS" ? `${formatPrice(Number(summary.esperado_cobrar_nativo), monedaNativa)} · los 39 ítems` : "precio × cantidad de todos los ítems"}</div></CardContent></Card>
