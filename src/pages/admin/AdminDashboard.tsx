...
const AdminDashboard = () => {
  ...
  const kpis = [
    ...
    { label: "Cobros pendientes", value: `$${cuotasEventos.monto.toLocaleString("es-AR")}`, hint: `${cuotasEventos.count} cuotas de eventos`, icon: DollarSign, color: "text-yellow-500", to: "/admin/eventos" },
