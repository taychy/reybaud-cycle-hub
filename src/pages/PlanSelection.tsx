    ...
    try {
      ...
      if (reused) {
        ...
        if (subError) {
          ...
          } else if (/No autorizado para modificar campos restringidos/i.test(msg)) {
            setError("Hubo un problema al cerrar tu período anterior. Recargá la página e intentá de nuevo; si sigue fallando, escribinos a administración.");
          } else {
            setError(`No pudimos crear el pago. Recargá la página e intentá de nuevo; si sigue fallando, escribinos a administración.${msg ? ` (detalle: ${msg.slice(0, 140)})` : ""}`);
          }
