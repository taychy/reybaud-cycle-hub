CREATE OR REPLACE FUNCTION public.assign_mp_movement_to_alumno(_movement_id uuid, _alumno_id uuid, _notes text DEFAULT NULL)
RETURNS jsonb
LANGUAGE plpgsql
SECURITY DEFINER
...
BEGIN
  ...
  -- Idempotencia: ajuste ya creado para este pago
  ...
  -- Anti-duplicado: el pago ya está reflejado por otra vía en la cuenta corriente
