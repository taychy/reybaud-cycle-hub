...
Deno.serve(async (req) => {
  ...
  // 1) Candidatas: subs 'activa', 'vencida' o 'finalizada' con fecha_fin < target, pagadas, no canceladas.
  //    Los tres estados representan períodos cerrados: 'activa' = aún no procesada por este cron;
