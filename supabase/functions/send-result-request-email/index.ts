  ...
  try {
    ...
    const emailHtml = `
      ...
      <body style="margin:0;padding:0;background-color:#ffffff;font-family:Arial,Helvetica,sans-serif;">
        <div style="max-width:480px;margin:0 auto;padding:32px 20px;">
          ...
          <p style="font-size:15px;color:#333;line-height:1.5;">
            Para generar el ranking necesitamos que cargues el tiempo de tu equipo en la app. Entrá al siguiente link y completalo:
          </p>
    ...
    const res = await fetch("https://api.resend.com/emails", {
      ...
      body: JSON.stringify({
        ...
        to: [email],
        subject: "Cargá tu tiempo – Record de la Hora",
        html: emailHtml,
      }),
    });

    const resData = await res.json();
    console.log("Result request email sent:", resData);
    ...
    console.error("Error sending result request email:", err);
    return new Response(
