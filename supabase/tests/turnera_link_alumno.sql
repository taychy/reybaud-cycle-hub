...
BEGIN
  ...
  INSERT INTO public.reservas_turnera (servicio_id, fecha, hora_inicio, hora_fin, nombre, apellido, email, precio_snapshot)
  VALUES (v_servicio, current_date + 30, '10:00', '11:00', 'ZZTest', 'Unico', 'ZZ.Test.Unico@Example.Invalid', 1000)
  ...
  INSERT INTO public.reservas_turnera (servicio_id, fecha, hora_inicio, hora_fin, nombre, apellido, documento, precio_snapshot)
  VALUES (v_servicio, current_date + 30, '12:00', '13:00', 'ZZTest', 'Unico', '90.111.222', 1000)
  ...
  INSERT INTO public.reservas_turnera (servicio_id, fecha, hora_inicio, hora_fin, nombre, apellido, email, precio_snapshot)
  VALUES (v_servicio, current_date + 30, '14:00', '15:00', 'ZZTest', 'Ambiguo', 'zz.test.ambiguo@example.invalid', 1000)
  RETURNING alumno_id INTO v_got;
  IF v_got IS NOT NULL THEN RAISE EXCEPTION 'FAIL ambiguo asignado: %', v_got; END IF;

  -- 4) sin coincidencia → NO asigna
  INSERT INTO public.reservas_turnera (servicio_id, fecha, hora_inicio, hora_fin, nombre, apellido, email, documento, precio_snapshot)
  VALUES (v_servicio, current_date + 30, '16:00', '17:00', 'ZZTest', 'Nadie', 'zz.test.nadie@example.invalid', '90999888', 1000)
  RETURNING alumno_id INTO v_got;
